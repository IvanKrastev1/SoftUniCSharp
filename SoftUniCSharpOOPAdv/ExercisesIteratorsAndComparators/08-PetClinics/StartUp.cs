...
//        {
//            List<string> commandTokens = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries).ToList();
...
//    private static void AddPetToClinic(string petName, string clicicName)
//    {
//        Pet currentPet = allPets[petName];
//        Clinic currentClinic = allClinics[clicicName];
